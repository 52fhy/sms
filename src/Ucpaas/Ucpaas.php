...
class Ucpaas
{
     ...
     * @return mixed|string
     * @throws Exception
     * @links http://www.ucpaas.com/page/doc/doc_rest3-3.jsp
     * @author by 余建材 2014-12-6 13:18:15
     */
    public function voiceNotify($appId,$content,$to,$toSerNum,$content_type='0',$type='json',$playTimes='1'){
    	$url = self::BaseUrl . self::SoftVersion . '/Accounts/' . $this->accountSid . '/Calls/voiceNotify?sig=' . $this->getSigParameter();
    	if($type == 'json'){
